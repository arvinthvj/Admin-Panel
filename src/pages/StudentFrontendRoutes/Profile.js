  ...
  return (
    <>
      <div className='RenderTeamDetailsMaster'>
        <div className='RenderCountAndFeedBackMaster'>{RenderTimeline()}</div>
    ...
    <div className='master_col_group_profile'>
      <div className='colonecard colg'>
          ...
          {userForAccInfo.length ? (
            <>
              <img
                ...
                src={require(`../Images/christmashat.png`).default}
              />
              <Avatar
                size={90}
                src={
        ...
        <div  style={{
          ...
          {userForAccInfo.length ? userForAccInfo[0].username : "Account Info"}
      ...
      <div className='coltwocard colg'>
        ...
        />
        <div>
          Your Attendance <h6>Calculated For : {userAttendanceForDays} days</h6>
        </div>
      </div>
